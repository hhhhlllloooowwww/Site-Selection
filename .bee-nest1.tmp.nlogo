  ...
  ask bees [
    ...
    if (within red-site) or (within blue-site) [
      ...
      if state = "dissemination" [
        set boundary arena
        if opinion = 1 [
          set time-on-nest max-time-on-nest * red-site-quality + random-normal 0, 0.1
          ;set heading towards one-of free nest ; return to nest
        ]
        if opinion = 2 [
          set time-on-nest max-time-on-nest * blue-site-quality + random-normal 0,0.1
          ;set heading towards one-of free nest ; return to nest
        ]
        set heading towards one-of free nest ; return to nest
      ]
