...
to setup
  clear-all
  set number-of-blue-bees 100 - number-of-red-bees
...
<experiments>
  ...
  <experiment name="Static-sub-5" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    ...
    <enumeratedValueSet variable="x-number-of-blue-bees">
      <value value="35"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="blue-site-quality">
      <value value="0.5"/>
